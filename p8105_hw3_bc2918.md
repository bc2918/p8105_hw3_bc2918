...
The average max temperature are well distributed around 0°C (\~ -10°C to
10°C) and 27°C (\~ 20°C to 35°C) in January and July respectively across
the years. Few outliers could be observed.
...
``` r
tmax_tmin_plot + snow_plot + plot_layout(widths = c(1, 3))
```
...
concentration between (-20°C, -10°C) and (20°C, 30°C). The second plot
indicated that the distribution of snowfall amount in each year did not
vary much and their mean values were pretty consistent around \~30 mm.
